...
#### you'll need to send a request to the API sending a json with the header "Content-Type: application/json" and to this point there is only 1 endpoint, it being a POST method, the json needs 2 members, "code" and "input", here's an example:
